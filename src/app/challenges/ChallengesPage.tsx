  ...
  return (
    <AppLayout user={user}>
      ...
      {activeTab === 'proclamation' && (
        <div className="mx-4 my-4 rounded-3xl border border-border bg-card p-4">
          <p className="text-sm text-muted-foreground">
            These are raised proclamations from the community. Back the issue by joining or accepting the proclamation.
          </p>
        </div>
      )}
